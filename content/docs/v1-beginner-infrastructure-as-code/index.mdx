...
## 🧠 Ship Infra Demo — Running a Local SLM
...
https://github.com/Ship-Infra/slm-llama-cpp-poc
...
This is infrastructure as code tutorial, so the code of the infrastructure is available in this [GitHub repository](https://github.com/Ship-Infra/ship-infra-project). Feel free to clone it and follow along!
