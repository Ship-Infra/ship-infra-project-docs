...
![alt text](./provisioning-dns-records-with-terraform/architecture.png)
...
This guide full code is available in https://github.com/Ship-Infra/ship-infra-project/tree/main/v2-ec2-http. Feel free to clone it and follow along!
...
![alt text](./provisioning-dns-records-with-terraform/cloudflare-namespaces.png)
