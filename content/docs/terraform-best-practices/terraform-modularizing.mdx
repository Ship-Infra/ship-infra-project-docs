...
This guide full code is available in https://github.com/Ship-Infra/ship-infra-project/tree/main/v3-terraform-modules. Feel free to clone it and follow along!
