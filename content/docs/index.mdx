...
This is infrastructure as code tutorial, so the code of the infrastructure is available in this [GitHub repository](https://github.com/vvasylkovskyi/ship-infra-project). Feel free to clone it and follow along!
