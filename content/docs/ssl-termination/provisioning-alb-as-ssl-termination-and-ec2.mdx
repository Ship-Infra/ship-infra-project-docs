...
This guide full code is available in https://github.com/vvasylkovskyi/ship-infra-project/tree/main/v6-ssl-load-balancer. Feel free to clone it and follow along!
